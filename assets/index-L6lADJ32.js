 ...
 */const K=r=>(t,e)=>{e!==void 0?e.addInitializer(()=>{customElements.define(r,t)}):customElements.define(r,t)},z={primary:f`#1A1A1D`,secondary:f`#3B1C32`,tertiary:f`#A64D79`,accent:f`#6A1E55`,ctext:f`#FFFFFF`,ctext_muted:f`#CCCCCC`};var Nt=Object.defineProperty,zt=Object.getOwnPropertyDescriptor,Rt=(r,t,e,s)=>{for(var i=s>1?void 0:s?zt(t,e):t,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=(s?o(t,e,i):o(i))||i);return s&&i&&Nt(t,e,i),i};let k=class extends A{render(){return Z`
        ...
        //     }
        // }
    `;k=Rt([K("presentation-section")],k);var Ht=Object.defineProperty,Dt=Object.getOwnPropertyDescriptor,It=(r,t,e,s)=>{for(var i=s>1?void 0:s?Dt(t,e):t,n=r.length-1,o;n>=0;n--)(o=r[n])&&(i=(s?o(t,e,i):o(i))||i);return s&&i&&Ht(t,e,i),i};let W=class extends A{render(){return Z`
            <h2>INSTALLATION</h2>
            <section class="cards">
